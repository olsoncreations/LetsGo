      ...
      <div style={{ maxWidth: 800, margin: "0 auto", padding: "40px 20px 80px" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 32, lineHeight: 1.7, fontSize: 14 }}>
          ...
          <Section title="1. Acceptance of Terms">
            <p>By creating an account, accessing, or using the Let&apos;s Go platform (&quot;Platform&quot;), including our website, mobile applications, application programming interfaces (APIs), and all related services (collectively, the &quot;Services&quot;), you (&quot;User,&quot; &quot;you,&quot; or &quot;your&quot;) agree to be bound by these Terms of Service (&quot;Terms&quot;). If you do not agree to these Terms in their entirety, you must not create an account or use the Services.</p>
            <p>These Terms constitute a legally binding agreement between you and Let&apos;s Go, LLC, a Nebraska limited liability company (&quot;Let&apos;s Go,&quot; &quot;we,&quot; &quot;us,&quot; or &quot;our&quot;). We reserve the right to update, modify, or replace any part of these Terms at any time by posting the revised Terms on the Platform. Your continued use of the Services after the posting of revised Terms constitutes your acceptance of those changes. It is your responsibility to review these Terms periodically.</p>
            <p>These Terms incorporate by reference our <a href="/privacy" style={{ color: "#00d4ff", textDecoration: "underline" }}>Privacy Policy</a>, which describes how we collect, use, and share your personal information. Together, these documents form the entire agreement between you and Let&apos;s Go regarding the Services.</p>
          </Section>
          ...
          <Section title="3. Account Registration and Security">
            ...
            <p><strong style={{ color: "#fff" }}>3.2 Account Security.</strong> You are solely responsible for maintaining the confidentiality of your account credentials, including your password. You are responsible for all activity that occurs under your account, whether or not authorized by you. You agree to notify us immediately at security@letsgolive.app of any unauthorized access to or use of your account.</p>
          ...
          <Section title="4. Description of Services">
            ...
            <p><strong style={{ color: "#fff" }}>4.3 Facilitator Role.</strong> Let&apos;s Go acts solely as a facilitator and technology platform connecting users with businesses. Let&apos;s Go is NOT a party to any transaction between you and any Participating Business. We do not own, operate, manage, or control any Participating Business. We do not guarantee the quality, safety, legality, or availability of any product, service, or experience offered by any Participating Business.</p>
            <p><strong style={{ color: "#fff" }}>4.4 No Agency Relationship.</strong> Nothing in these Terms creates an employer-employee, partnership, joint venture, agency, or franchise relationship between you and Let&apos;s Go, or between any Participating Business and Let&apos;s Go. Users are not employees, contractors, or agents of Let&apos;s Go.</p>
          </Section>
          ...
          <Section title="5. Payout Program and Cash-Back Rewards">
            ...
            <p><strong style={{ color: "#fff" }}>5.3 No Guarantee of Payouts.</strong> Payouts are subject to receipt verification and approval by the Participating Business and/or Let&apos;s Go. We reserve the right to deny, adjust, reverse, or reclaim any Payout for any reason, including but not limited to: suspected fraud; receipt manipulation; system errors; violation of these Terms; business dispute; or at our sole discretion.</p>
            <p><strong style={{ color: "#fff" }}>5.4 Payout Amounts May Change.</strong> Participating Businesses may modify their payout tier structures at any time. Let&apos;s Go does not guarantee any specific payout rate, amount, or availability. Past payout rates do not guarantee future rates. The Platform merely facilitates rewards as configured by Participating Businesses.</p>
            ...
            <p><strong style={{ color: "#fff" }}>5.6 Payout Methods.</strong> Available payout methods include Venmo, PayPal, and bank transfer (ACH). You are responsible for providing accurate payout account information. Let&apos;s Go is not responsible for Payouts sent to an incorrect account due to information you provided. Payout processing times vary and are typically 1 to 3 business days. We are not responsible for delays caused by third-party payment processors.</p>
            <p><strong style={{ color: "#fff" }}>5.7 Payouts Are Not Wages.</strong> Payouts are cash-back rewards, not wages, salary, or employment compensation. You are not an employee of Let&apos;s Go or any Participating Business by virtue of receiving Payouts. Payouts may constitute taxable income (see Section 6).</p>
            ...
            <p><strong style={{ color: "#fff" }}>5.9 Reversal and Reclamation.</strong> If a Payout was issued in error, due to fraud, or based on a receipt that is subsequently disputed, reversed, or found to be invalid, Let&apos;s Go reserves the right to reverse the Payout and deduct the amount from your available balance. If your balance is insufficient, you agree to remit the overpayment amount to Let&apos;s Go within thirty (30) days of written notice.</p>
          </Section>

          <Section title="6. Tax Obligations">
            <p><strong style={{ color: "#fff" }}>6.1 User Responsibility.</strong> You are solely responsible for determining and fulfilling all tax obligations arising from Payouts received through the Platform, including all federal, state, and local income taxes, self-employment taxes (if applicable), and any other taxes that may apply. Let&apos;s Go does not withhold taxes from Payouts unless required by law.</p>
            <p><strong style={{ color: "#fff" }}>6.2 IRS 1099 Reporting.</strong> Under United States tax law (Internal Revenue Code Section 6050W and related provisions), if you receive six hundred dollars ($600.00) or more in Payouts within a calendar year, Let&apos;s Go is required to report these earnings to the Internal Revenue Service (IRS) and provide you with a Form 1099-NEC or Form 1099-MISC, as applicable. You will be required to provide your legal name, mailing address, and Social Security Number (SSN) or Taxpayer Identification Number (TIN) for tax reporting purposes. Failure to provide this information may result in the suspension of Payouts.</p>
            <p><strong style={{ color: "#fff" }}>6.3 Backup Withholding.</strong> If you fail to provide a valid SSN or TIN, or if the IRS notifies us that the information you provided is incorrect, Let&apos;s Go may be required to withhold twenty-four percent (24%) of your Payouts as backup withholding in accordance with IRS regulations. Any amounts withheld will be remitted to the IRS on your behalf.</p>
            ...
            <p><strong style={{ color: "#fff" }}>6.5 No Tax Advice.</strong> Let&apos;s Go does not provide tax, legal, or financial advice. We strongly recommend that you consult a qualified tax professional regarding your specific tax obligations related to Payouts received through the Platform.</p>
            <p><strong style={{ color: "#fff" }}>6.6 Record Retention.</strong> Let&apos;s Go retains Payout records, receipt data, and related financial information for a minimum of seven (7) years to comply with IRS recordkeeping requirements, even if you delete your account or request account deletion.</p>
          </Section>
          ...
          <Section title="7. Receipts and Verification">
            ...
            <p><strong style={{ color: "#fff" }}>7.4 Verification Rights.</strong> Let&apos;s Go and Participating Businesses reserve the right to verify any receipt through manual review, automated fraud detection systems, image analysis, cross-referencing with business records, or by contacting the business directly. We may request additional documentation, including but not limited to bank or credit card statements, to verify the authenticity of a receipt.</p>
          ...
          <Section title="8. Fraud Detection and Account Termination">
            ...
            <p><strong style={{ color: "#fff" }}>8.4 Cooperation.</strong> You agree to cooperate with Let&apos;s Go and law enforcement in any fraud investigation related to your account. Refusal to cooperate may result in account termination.</p>
          </Section>
          ...
          <Section title="9. Social Features and Contact Importing">
            ...
            <p><strong style={{ color: "#fff" }}>9.2 Contact Importing.</strong> The Platform offers the ability to import contacts from your device to find friends who are already on Let&apos;s Go and to invite contacts who are not. Contact importing uses your device&apos;s native Contact Picker (where available) and requires your explicit permission via your device&apos;s operating system. We do not access your contacts without your affirmative consent. Imported contact data (names, email addresses, phone numbers) is used solely to match against existing users and to send invitation emails on your behalf. We do not sell, rent, or share imported contact data with third parties.</p>
            <p><strong style={{ color: "#fff" }}>9.3 Invitation Emails.</strong> When you choose to invite contacts, Let&apos;s Go sends invitation emails on your behalf using your name. You are responsible for ensuring that you have the right to share the contact information of the individuals you invite. Invitation sending is rate-limited to one hundred (100) per day per user to prevent abuse. Recipients may unsubscribe from future invitation emails.</p>
          ...
          <Section title="13. Business Account Registration">
            ...
            <p><strong style={{ color: "#fff" }}>13.3 Verification.</strong> Businesses must submit verification documents during onboarding, which may include a business license, EIN certificate, or utility bill matching the business name and address. Let&apos;s Go reserves the right to request additional verification at any time and to deny or revoke Business Account status if verification is unsatisfactory.</p>
          ...
          <Section title="15. Advertising and Promotions">
            ...
            <p><strong style={{ color: "#fff" }}>15.3 Hot Day Surge Pricing.</strong> Advertising campaigns scheduled during high-demand dates (&quot;Hot Days&quot;) may be subject to surge pricing. Surge fees, if applicable, will be clearly displayed before purchase and require your explicit confirmation. Hot Day pricing is determined by Let&apos;s Go in its sole discretion.</p>
            <p><strong style={{ color: "#fff" }}>15.4 No Performance Guarantee.</strong> Let&apos;s Go does not guarantee any specific results, impressions, clicks, visits, conversions, revenue, or return on investment from advertising campaigns. Advertising campaign fees are non-refundable once the campaign has commenced, except in cases of material platform failure as determined by Let&apos;s Go in its sole discretion.</p>
            <p><strong style={{ color: "#fff" }}>15.5 Ad Content.</strong> All advertising content must comply with applicable laws and regulations. Let&apos;s Go reserves the right to reject, modify, or remove any advertising content that violates these Terms, applicable law, or our content standards.</p>
          </Section>
          ...
          <Section title="17. Platform Fees and Billing">
            ...
            <p><strong style={{ color: "#fff" }}>17.7 Tax Reporting for Businesses.</strong> Businesses are responsible for all tax obligations related to their participation in the Platform, including reporting Payout expenses and Platform Fees. Let&apos;s Go may issue tax forms to businesses as required by law.</p>
          </Section>
          ...
          <Section title="18. Receipt Approval and Dispute">
            ...
            <p><strong style={{ color: "#fff" }}>18.4 Dispute Resolution.</strong> If a business disputes an approved receipt within the 30-day window, Let&apos;s Go will investigate and make a determination in its sole discretion. If the dispute is upheld, the user&apos;s Payout will be reversed and the receipt will be removed from the user&apos;s visit history.</p>
          </Section>
          ...
          <Section title="20. Business Independence and Compliance">
            <p><strong style={{ color: "#fff" }}>20.1 Independent Operation.</strong> Participating Businesses are independent entities. Let&apos;s Go does not exercise control over business operations, employment practices, products, services, pricing, health and safety compliance, or any other aspect of business operations. The relationship between Let&apos;s Go and Participating Businesses is that of independent contractors.</p>
          ...
          <Section title="21. Assumption of Risk and Limitation of Liability">
            <p><strong style={{ color: "#fff" }}>21.1 Assumption of Risk.</strong> You acknowledge and agree that your use of the Services and any visits to businesses discovered through the Platform are entirely at your own risk. Let&apos;s Go is a technology platform only and does not own, operate, manage, inspect, or control any businesses listed on the Platform.</p>
            <p><strong style={{ color: "#fff" }}>21.2 Physical Safety.</strong> Let&apos;s Go is NOT responsible for any injury, illness, death, property damage, theft, assault, or any other harm that may occur during your visit to any business or location discovered through the Platform. This includes but is not limited to:</p>
            <ul style={{ paddingLeft: 20, margin: "8px 0" }}>
            ...
            <p><strong style={{ color: "#fff" }}>21.3 Business Quality.</strong> Let&apos;s Go does NOT inspect, endorse, guarantee, or warrant the quality, safety, legality, cleanliness, or suitability of any business, its products, services, premises, health and safety compliance, food handling practices, employee conduct, or any other aspect of its operation. Business listings and information are provided &quot;as-is&quot; and may be inaccurate, incomplete, or outdated.</p>
            <p><strong style={{ color: "#fff" }}>21.4 Alcohol, Substances, and Impairment.</strong> If you choose to consume alcohol or any other substances at businesses discovered through the Platform, you do so entirely at your own risk and your own volition. Let&apos;s Go is NOT responsible for any consequences arising from alcohol or substance consumption, including but not limited to: impaired judgment; impaired driving; DUI, DWI, or other criminal charges; injuries sustained while impaired; injuries caused to others while impaired; or any other consequences. YOU ARE SOLELY RESPONSIBLE FOR ARRANGING SAFE TRANSPORTATION. Let&apos;s Go strongly encourages the use of designated drivers, ride-sharing services, or public transportation when consuming alcohol.</p>
            <p><strong style={{ color: "#fff" }}>21.5 Age-Restricted Venues.</strong> Some businesses listed on the Platform may have age restrictions (18+ or 21+). It is YOUR sole responsibility to verify that you meet any applicable age requirements before visiting a business. Let&apos;s Go does not verify your age at the point of entry to any business.</p>
          ...
          <Section title="29. Termination">
            <p><strong style={{ color: "#fff" }}>29.1 Termination by Let&apos;s Go.</strong> We may suspend or terminate your access to the Services at any time, with or without cause, and with or without notice, at our sole discretion. Grounds for termination include but are not limited to: violation of these Terms; fraudulent activity; non-payment of charges; inactivity; or any conduct that we determine, in our sole discretion, is harmful to other users, Participating Businesses, or Let&apos;s Go.</p>
          ...
          <Section title="34. Waiver">
            <p>The failure of Let&apos;s Go to enforce any right or provision of these Terms shall not constitute a waiver of that right or provision. Any waiver of any provision shall be effective only if in writing and signed by an authorized representative of Let&apos;s Go. A waiver of any right or provision on one occasion shall not be deemed a waiver of that right or provision on any subsequent occasion.</p>
          </Section>

          <Section title="35. Assignment">
            <p>You may not assign, transfer, or delegate your rights or obligations under these Terms without Let&apos;s Go&apos;s prior written consent. Let&apos;s Go may freely assign, transfer, or delegate its rights and obligations under these Terms without restriction, including in connection with a merger, acquisition, reorganization, or sale of assets.</p>
          </Section>

          <Section title="36. Entire Agreement">
            <p>These Terms, together with the Privacy Policy and any additional terms you agree to when using specific features of the Services (including the Business Billing Policy, Content Policy, and Fraud Acknowledgment accepted during business onboarding), constitute the entire agreement between you and Let&apos;s Go regarding the Services and supersede all prior and contemporaneous agreements, proposals, negotiations, representations, and understandings, whether written or oral.</p>
          </Section>
