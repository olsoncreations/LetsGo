        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 32, lineHeight: 1.7, fontSize: 14 }}>
          ...
          <Section title="4. How We Share Your Information">
            ...
            <ul style={{ paddingLeft: 20, margin: "8px 0" }}>
              ...
              <li><strong>Twilio:</strong> SMS / text message delivery for friend invitations, account notifications, and transactional alerts (receives recipient mobile phone numbers and message content; bound by Twilio&apos;s data processing terms and applicable carrier requirements)</li>
          ...
          <Section title="5. Contact Data, Invitations, and SMS Messaging">
            ...
            <p><strong style={{ color: "#fff" }}>5.5 SMS / Text Messaging Program.</strong> LetsGo offers SMS messaging as an optional channel for friend invitations and account-related notifications. The categories of SMS messages we may send include: (a) friend invitations that you, the user, explicitly initiate by selecting a contact and tapping &quot;invite&quot;; (b) receipt approval, rejection, and Payout status notifications; (c) account security alerts (such as login or password reset notifications); and (d) other transactional notifications related to your account. We do NOT send unsolicited promotional or marketing text messages.</p>

            <p><strong style={{ color: "#fff" }}>5.6 SMS Consent and Opt-In.</strong> SMS consent is collected at the point you provide your mobile phone number and affirmatively choose to receive text messages from LetsGo, or at the point you initiate an SMS-based action (such as inviting a friend by text). By providing your mobile phone number and consenting, you agree to receive SMS messages from LetsGo at the number you provided, sent via an automatic telephone dialing system. Consent to receive SMS messages is not a condition of using the Services or making any purchase.</p>

            <p><strong style={{ color: "#fff" }}>5.7 Mobile Information Sharing — No Third-Party Sharing for Marketing.</strong> <strong style={{ color: "#fff" }}>Mobile phone numbers and SMS opt-in consent are not shared with third parties or affiliates for marketing or promotional purposes.</strong> Mobile information is shared only with Twilio (our SMS delivery provider) and applicable mobile carriers solely as necessary to deliver the messages you have requested or that are required for the operation of your account. No mobile opt-in data is sold, rented, leased, or otherwise transferred to any third party for that party&apos;s own marketing or promotional use.</p>

            <p><strong style={{ color: "#fff" }}>5.8 Opt-Out, Help, Frequency, and Carrier Charges.</strong> You may opt out of SMS messages from LetsGo at any time by replying <strong style={{ color: "#fff" }}>STOP</strong> to any text message you receive from us. Once you reply STOP, you will receive a confirmation message and will not receive further SMS messages unless you re-enroll. For help, reply <strong style={{ color: "#fff" }}>HELP</strong> or contact us at support@useletsgo.com. Message frequency varies based on your activity (for example, the number of friend invitations you initiate or receipts you submit). <strong style={{ color: "#fff" }}>Message and data rates may apply</strong> depending on your mobile carrier and plan. LetsGo is not responsible for any charges from your wireless carrier. Supported carriers include all major U.S. carriers; carriers are not liable for delayed or undelivered messages.</p>
          </Section>
